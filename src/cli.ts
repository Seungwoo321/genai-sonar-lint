...
program
  ...
  .option('-a, --auto-fix', 'Auto-fix all issues using AI (file by file)')
...
Examples:
  ...
  $ genai-sonar-lint analyze src/ -a         # AI auto-fix mode (file by file)
  $ genai-sonar-lint analyze src/ -a -p cursor-cli  # Auto-fix with Cursor CLI
